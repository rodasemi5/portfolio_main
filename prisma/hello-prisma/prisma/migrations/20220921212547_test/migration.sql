...
CREATE TABLE "UserPerference" (
    ...
    CONSTRAINT "UserPerference_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "UserPerference" ADD CONSTRAINT "UserPerference_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
